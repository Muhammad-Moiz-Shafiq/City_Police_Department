...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto " href="#Breakthroughs">Breakthroughs</a></li>
          <li><a class="nav-link scrollto" href="#team">Officers</a></li>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="hero" class="d-flex align-items-center justify-content-center" style="background-image: url(./assets/img/Flag.jpeg);">
    <div class="container" data-aos="fade-up">

      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          <h1>To Serve and Protect Our Country<span>.</span></h1>
          <h2>Always Stand With People</h2>
        </div>
      </div>
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="images/about.jpg" class="img-fluid" alt="Photo of PPIC3 center Lahore">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
            <h3>The Punjab Police is a law enforcement agency of Punjab, Pakistan.</h3>
            <p class="fst-italic">
              Under the command of its Inspector General (IG), it administers all criminal cases under the Police Acts of 1861 and 2002. The force was introduced in its modern form under British rule, and a colonial influence continues. On 23 January 2023, Dr. Usman Anwar was appointed as the Inspector General of Punjab Police.
            </p>
            <p>
    ...
    <section id="features" class="features">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <h3>Our Mission:</h3>
          <div class="image col-lg-6" style='background-image: url("assets/img/force.jpg");' data-aos="fade-right"></div>
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="100">
            <div class="icon-box mt-5 mt-lg-0" data-aos="zoom-in" data-aos-delay="150">
              <i class="bx bx-shield"></i>
              <h4>Protect life, property and liberty of citizens.</h4>

            </div>
            <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
              <i class="bx bx-lock"></i>
              <h4>Preserve and promote public peace.</h4>

            </div>
            <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
              <i class="bx bx-user-check"></i>
              <h4>Ensure that the rights and privileges, under the law, of a person taken in custody are protected.</h4>

            </div>
            <div class="icon-box mt-5" data-aos="zoom-in" data-aos-delay="150">
              <i class="bx bx-badge-check"></i>
              <h4>Prevent the commission of offences and public nuisance.</h4>
              ...
              <div class="row">
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <span data-purecounter-start="0" data-purecounter-end="10131" data-purecounter-duration="2" class="purecounter"></span>
                    <p><strong>Total Complaints</strong> uptil now.</p>
                  </div>
                </div>
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <span data-purecounter-start="0" data-purecounter-end="9472" data-purecounter-duration="2" class="purecounter"></span>
                    <p><strong>Disposed</strong> complaints</p>
                  </div>
                </div>
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <span data-purecounter-start="0" data-purecounter-end="8978" data-purecounter-duration="4" class="purecounter"></span>
                    <p><strong>Addressed</strong> complaints uptil now</p>
                  </div>
                </div>
                ...
                <div class="col-md-6 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    ...
                    <span data-purecounter-start="0" data-purecounter-end="630" data-purecounter-duration="4" class="purecounter"></span>
    ...
    <section id="Breakthroughs" class="container">
      <div class="section-title">
      ...
      <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active position-relative">
            <h2 class="position-relative top-0 start-0 mt-12 ms-12">><strong>Punjab Police signs MoU with Educational Institutes</strong></h2>
            <img src="br1.png" class="d-block w-100 center opacity-80" alt="Recent MoU b/w Punjab Police and Educational institutes (Source: pakobserver.net)">
          </div>
          <div class="carousel-item">
            <h2 class="position-relative top-0 start-0 mt-12 ms-12">><strong>CM Maryam Nawaz dons police uniform during passing out parade</strong></h2>
            <img src="./br2.jpg" class="d-block w-100 center" alt="Cm Maryam Nawaz attends Passing out of Punjab Police 2024(source: The news)">
          </div>
          <div class="carousel-item">
            <h2 class="position-relative top-0 start-0 mt-12 ms-12">><strong>ASP Sheharbano hailed as a hero after rescuing woman from charged mob in Lahore</strong></h2>
            <img src="./br3.jpg" class="d-block w-100" alt="ASP Sheharbano Naqvi giving interview to BBC(Photo courtesy BBC)">
          </div>
        </div>
    ...
    </section><!-- End BreakThroughs Section -->
    ...
    <section id="team" class="team">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Officers</h2>
          <p>Our Distinguished Officers</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="member-img">
                <img src="images/off1.png" class="img-fluid" alt="Dr.Usman Anwar IGP">

              </div>
              <div class="member-info">
                <h4>Dr. Usman Anwar</h4>
                <span>Inspector-General of Punjab Police</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="200">
              <div class="member-img">
                <img src="images/off2.png" class="img-fluid" alt="M. Faisal kamran DIG">

              </div>
              <div class="member-info">
                <h4>Muhammad Faisal Kamran</h4>
                <span>DIG Ops. Lahore</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="300">
              <div class="member-img">
                <img src="images/off3.png" class="img-fluid" alt="DIG Imran Kishwar">

              </div>
              <div class="member-info">
                <h4>Imran Kishwar</h4>
                <span>DIG OCU Lahore</span>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="400">
              <div class="member-img">
                <img src="images/off4.png" class="img-fluid" alt="Atif Nazir SSP">

              </div>
              <div class="member-info">
                <h4>Atif Nazir</h4>
                <span>SSP Administration Lahore</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4  footer-links fs-6">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#Breakthroughs">Breakthroughs</a></li>
