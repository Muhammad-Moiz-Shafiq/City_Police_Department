    ...
    <section class="inner-page">
      ...
      <?php
          include_once './backend/db.php'; // Include database connection file
            ...
            $sql = "SELECT name,rank,age,posting,contact_no FROM commisionedofficer";
          ...
          if (isset($result)) {
            if ($result->num_rows > 0) {
              echo "<section><div class='container' data-aos='fade-up'><h3 class='fw-bold'>Officers details are as follows:</h3>";
              echo "<table class='table table-striped'>";
              echo "<thead><tr><th>Officer Name</th><th>Rank</th><th>Age</th><th>Posted in</th><th>Office No.</th></tr></thead><tbody>";
